...
hdi_data.confident= read.csv(paste("./explaining-away-runs/main-confident/hdi_samples.csv", sep=""))
...
Inferred thresholds:
```{r model1_data, echo=FALSE}
d.opt.norming = convertData("./explaining-away-runs/norming-good-mood/cost-fixed/run1_output.json")
d.opt.norming = reparam(d.opt.norming)
d.opt.norming = tidy_sampleList(d.opt.norming, 1, 1, list())
d.opt.norming$condition = "optimist"

d.psmst.norming = convertData("./explaining-away-runs/norming-bad-mood/cost-fixed/run1_output.json")
d.psmst.norming = reparam(d.psmst.norming)
d.psmst.norming = tidy_sampleList(d.psmst.norming, 1, 1, list())
d.psmst.norming$condition = "pessimist"
