...
```{r data, echo=FALSE}
trials_cond1 = format_data(read.csv("../../02_norming/data/02_norming_cond1-trials.csv"))
trials_cond2 = format_data(read.csv("../../02_norming/data/02_norming_cond2-trials.csv"))
trials_cond3 = format_data(read.csv("../data/05_norming_cond3-trials.csv"))
...
d3 = d3 %>% filter(!(workerid %in% exclude))
```
...
plot_2conditions = function(d1, d2, plot_title) {
  ...
  d = rbind(d1,d2)
  d$condition = factor(d$Answer.condition)
...
ps2 = plot_conditions(d2, "Pessimist")
ps3 = plot_conditions(d3, "Neutral")

#ps12 = plot_2conditions(d1, d2, "Optimist-pessimist")
ps13 = plot_2conditions(d1, d3, "Optimist-neutral")
#ps23 = plot_2conditions(d2, d3, "Pessimist-neutral")
...
aucs.neutral = d3 %>% auc_for_participants(., method=auc_method1)

aucs.neutral$cond = "Neutral condition"

aucs.all = rbind(aucs.optimist, aucs.pessimist, aucs.neutral)
