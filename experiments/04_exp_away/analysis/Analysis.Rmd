...
```{r}
mood2 = read.csv("../data/04_exp_away_cond2-mood_ratings.csv")
mood2$Answer.condition = "Confident"
mood3 = read.csv("../data/04_exp_away_cond3-mood_ratings.csv")
mood3$Answer.condition = "Pessimist"
mood4 = read.csv("../data/04_exp_away_cond4-mood_ratings.csv")
...
auc.all4 = rbind(aucs.confident, aucs.cautious)
