...
colscale = scale_color_manual(
  values=c("#632121", "#d06262", "#214078", "#628ad0"),
...
colscale_fill = scale_fill_manual(
  values=c( "#214078", "#d06262", "#632121", "#628ad0"),
...
plot_expression = function(d, colscale, exp = "Exp. 1:") {
  ...
  p1 <- ggplot(d, aes(x=percent_window, y=mu, col=Answer.condition, pch=Answer.condition)) + 
    ...
    colscale +
    scale_shape_manual(values=c(16, 17, 3, 15, 3), breaks=c("optimist", "pessimist", "cautious", "confident", "neutral"))
...
ggsave("../abstracts/amlap2020/plots/norming.pdf", plot=plot.norming, width=14, height=4, units="cm", scale = 1.75)
...
ggsave("../abstracts/amlap2020/plots/exp.pdf", plot=plot.exp, width=14, height=4, units="cm", scale = 1.75)
