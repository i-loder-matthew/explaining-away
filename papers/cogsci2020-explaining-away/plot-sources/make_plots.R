...
colscale3 = scale_color_manual(
  ...
  labels=c("optimist incongr.", "pessimist incongr.", "cautious", "confident"),
  name="Cond."
) 
...
plot_expression = function(d, colscale, exp = "Exp. 1:") {
  ...
  p1 <- ggplot(d, aes(x=percent_window, y=mu, col=Answer.condition, pch=Answer.condition)) + 
    ...
    guides(pch=guide_legend(title="", title.position = "top" ),
           col=guide_legend(title="",title.position = "top")) +
    facet_wrap(~modal) +
    theme(legend.position="right") + 
    colscale +
    scale_shape_manual(values=c(16, 17, 16, 17, 15, 3, 2), 
                       breaks=c("optimist", "pessimist", "optimist incongruent", "pessimist incongruent", "cautious", "confident", "neutral"),
                       labels=c("optimist", "pessimist", "optimist incongr.", "pessimist incongr.", "cautious", "confident", "neutral"),
                       name="Cond.") +
...
ggsave("../papers/cogsci2020-explaining-away/plots/norming.pdf", plot=plot.norming, width=7, height=4, units="cm", scale = 1.75)
...
ggsave("../papers/cogsci2020-explaining-away/plots/explaining-away.pdf", plot=plot.exp, width=7, height=4, units="cm", scale = 1.75)



plot.exp3= plot_expression(d_means.exp3, colscale3, exp="Exp. 3:")  + theme(legend.margin=margin(-20,0,0,-25))
ggsave("../papers/cogsci2020-explaining-away/plots/incongruent.pdf", plot=plot.exp3, width=7, height=4, units="cm", scale = 1.75)
...
ggsave("../papers/cogsci2020-explaining-away//plots/mood-differences-exp2.pdf", plot=mood_plot, width=5, height=4, units="cm", scale = 1.75)
